...
const buildTuples: BuildTuple[] = [
    ...
    [3622, "2026-02-19", "setup_ksa_v2026.2.18.3622.exe", null, "setup_ksa_v2026.2.18.3622.tar", null, "first linux build"],
    ...
    [4631, "2026-06-19", "setup_ksa_v2026.6.8.4680.exe", null, "setup_ksa_v2026.6.8.4680.tar.gz", null, null],
];
